...
public class ProductCommandController {
    ...
    public ResponseEntity<ResponseId> createProduct(
            @Valid @ModelAttribute ProductRequestModel productRequestModel) {
        String imageUrl = null;
        if (productRequestModel.getImage() != null && !productRequestModel.getImage().isEmpty()) {
            imageUrl = cloudinaryStorageService.uploadSingleFile(productRequestModel.getImage());
        }
    ...
    public ResponseEntity<ResponseId> updateProduct(
            @Valid @ModelAttribute ProductRequestModel productRequestModel,
    ...
    public ResponseEntity<ResponseId> deleteProduct(@PathVariable String productId) {
